...
import kubernetes from "/public/svg/skills/kubernetes-icon.svg";
import redux from "/public/svg/skills/js_redux-icon.svg";
import dotnet from "/public/svg/skills/dotnet-icon.svg";
